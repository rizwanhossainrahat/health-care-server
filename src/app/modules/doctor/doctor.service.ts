...
const getAISuggestions=async(payload:{symtoms:string})=>{
    console.log(payload.symtoms)
    if(!(payload && payload.symtoms)){
        throw new ApiError(httpStatus.BAD_REQUEST,"symtoms is required")
    }
